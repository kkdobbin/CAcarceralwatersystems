...
#create dataset with NAs (not asssessed) removed
...
```{r chisquared table, warning=FALSE, message=FALSE}
...
status$Outcome <- "Risk assessment status"
...
Data_notassessedremoved_small <- Data_notassessedremoved[, c(8,24,25,27,29,6,18,19,15,20)]
...
NA_WQ <- glm(Water_Quality_Risk_Level_Display ~ carceral_sys + population_served_count + watersource + purchased + CASDWIS_Type + HR_NAME, data = Data_notassessedremoved_small, family = binomial)
summary(NA_WQ)

NA_AC <- glm(Accessability_Risk_Level_Display ~ carceral_sys + population_served_count + watersource + purchased + CASDWIS_Type + HR_NAME, data = Data_notassessedremoved_small, family= binomial)
summary(NA_AC)

NA_TMF <- glm(TMF_Capacity_Risk_Level_Display ~ carceral_sys + population_served_count + watersource + purchased + CASDWIS_Type + HR_NAME, data = Data_notassessedremoved_small, family= binomial)
summary(NA_TMF)
