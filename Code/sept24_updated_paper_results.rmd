...
Our data set includes `r nrow(Data)` unique public water systems representing all of the active CWS and NTNCWS water systems in the same. Of these water systems `r sum(Data$CASDWIS_Type == "C")` are community water systems, `r sum(Data$CASDWIS_Type == "NTNC")` are Non-Transient Non-Community systems. The mean population served by these systems is `r mean(Data$population_served_count)`. 
